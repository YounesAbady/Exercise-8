...
namespace YumCity_Migrations.EntityClasses
{
	...
	
	{
		...
		protected class IngredientEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("IngredientEntity", InheritanceHierarchyType.None, false, (int)YumCity_Migrations.EntityType.IngredientEntity, typeof(IngredientEntity), typeof(IngredientEntityFactory), false);
				AddNavigatorMetaData<IngredientEntity, RecipeEntity>("Recipe", "Ingredients", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, YumCity_Migrations.RelationClasses.StaticIngredientRelations.RecipeEntityUsingRecipeIdStatic, ()=>new IngredientRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)IngredientFieldIndex.RecipeId }, null, true, (int)YumCity_Migrations.EntityType.RecipeEntity);
			}
		}
		...
		/// <summary>The Data property of the Entity Ingredient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ingredient"."Data".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Data
		{
			get { return (System.String)GetValue((int)IngredientFieldIndex.Data, true); }
			set	{ SetValue((int)IngredientFieldIndex.Data, value); }
		}
		...
		/// <remarks>Mapped on  table field: "Ingredient"."RecipeId".<br/>Table field type characteristics (type, precision, scale, length): Uuid, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
