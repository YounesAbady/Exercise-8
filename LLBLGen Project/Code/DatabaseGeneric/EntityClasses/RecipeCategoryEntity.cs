...
namespace YumCity_Migrations.EntityClasses
{
	...
	
	{
		...
		protected class RecipeCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeCategoryEntity", InheritanceHierarchyType.None, false, (int)YumCity_Migrations.EntityType.RecipeCategoryEntity, typeof(RecipeCategoryEntity), typeof(RecipeCategoryEntityFactory), false);
				AddNavigatorMetaData<RecipeCategoryEntity, RecipeEntity>("Recipe", "RecipeCategories", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, YumCity_Migrations.RelationClasses.StaticRecipeCategoryRelations.RecipeEntityUsingRecipeIdStatic, ()=>new RecipeCategoryRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)RecipeCategoryFieldIndex.RecipeId }, null, true, (int)YumCity_Migrations.EntityType.RecipeEntity);
			}
		}
		...
		/// <summary>The Data property of the Entity RecipeCategory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "RecipeCategory"."Data".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Data
		{
			get { return (System.String)GetValue((int)RecipeCategoryFieldIndex.Data, true); }
			set	{ SetValue((int)RecipeCategoryFieldIndex.Data, value); }
		}
		...
		/// <remarks>Mapped on  table field: "RecipeCategory"."RecipeId".<br/>Table field type characteristics (type, precision, scale, length): Uuid, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
